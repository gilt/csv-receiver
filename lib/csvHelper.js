...
exports.Csv.prototype.load = function(rawBody, existingHeader) {
  var outer = this;
  outer.rawBody = rawBody || '';
  return csv
  .parseAsync(outer.rawBody)
...
exports.Csv.prototype.save = function(bucket, key) {
  ...
  return Promise.try(function() {
    ...
    return csv.stringifyAsync(outer.body)
...
exports.Csv.prototype.setHeader = function(header) {
  var outer = this;
  outer.header = header;
  return csv.stringifyAsync([outer.header])
